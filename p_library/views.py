...
def publisher_list(request):
    ...
    books = Book.objects.filter(publisher__isnull=False)
    publishers = Publisher.objects.all().annotate(Count('book'))

    template_data = {"": "мою библиотеку", "publishers": publishers, "books": books}
